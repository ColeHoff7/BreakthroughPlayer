...
public class TestBreakthroughPlayer extends GamePlayer {
	...
	public TestBreakthroughPlayer(String n)
	{
	...
	public TestBreakthroughPlayer(String n, float count, float jep, float max, float avg)
	{
		super(n, "Breakthrough");
		moves = new ScoredBreakthroughMove[depthLimit+1];
		for(int i = 0; i < moves.length; i++){
